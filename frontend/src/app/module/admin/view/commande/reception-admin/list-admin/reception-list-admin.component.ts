...
export class ReceptionListAdminComponent extends AbstractListController<ReceptionDto, ReceptionCriteria, ReceptionService>  implements OnInit {
    ...
    constructor(receptionService: ReceptionService, private commandeService: CommandeService,private receptionItemService: ReceptionItemService, private etatReceptionService: EtatReceptionService) {
