...
CommandeItemHistoryDao> implements CommandeItemAdminService {
    ...
    public CommandeItem findByProduitReferenceAndCommandeId(String produitReference, Long commandeId) {
        return dao.findByProduitReferenceAndCommandeId(produitReference, commandeId);
    }
