...
import ma.sir.easystock.service.impl.admin.ReceptionAdminServiceImpl;
...
public class ReceptionRestAdmin  extends AbstractController<Reception, ReceptionDto, ReceptionHistory, ReceptionCriteria, ReceptionHistoryCriteria, ReceptionAdminService, ReceptionConverter> {
    ...
    @Autowired
    private ReceptionAdminServiceImpl receptionAdminServiceIml;
    ...
    @PostMapping("prepare")
    public ReceptionDto prepare(@RequestBody Commande commande) {
        Reception reception = receptionAdminServiceIml.prepare(commande);
        ReceptionDto receptionDto = converter.toDto(reception);
        return receptionDto;
    }
